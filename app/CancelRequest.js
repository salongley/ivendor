...
module.exports = function CancelRequest(job) {
...
<div class="card-header" style="background: linear-gradient(to right, #FF5833 0%, #CD0000 100%); color: #ffffff">
...
<p>Please find below the details of a CANCELLED request and a summary of details.</p>
<div class="card-text">
